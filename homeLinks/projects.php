...
<body>
    <h1
        class="raleway-font w-full h-[30%] py-20 mx auto grid place-content-center bg-blue-200  white text-gray-900 text-4xl font-bold">
        Welcome
        to our Students Projects page
    </h1>
</body>
